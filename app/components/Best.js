                ...
                {sortedBooks.map((book, index) => (
                    ...
                    >
                        <div className="flex flex-col items-center w-full">
                            <img src={hoveredBookIndex === index ? book.images[1] : book.images[0]} alt={book.title} className="w-full h-48 md:h-64 object-cover mb-4 duration-300" />
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                    ...
                    >
                        <div className="md:flex w-full justify-center items-center">
                            ...
                            <div className="md:ml-6 flex flex-col w-full md:px-8">
                                <div>
